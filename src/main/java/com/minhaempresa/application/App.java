...
/*
    ...
    Está classe representa uma aplicação que usa os serviços disponíveis.

    Esta classe desconhece como as informações são persistidas (mantidas, guardadas),

    ela não tem conhecimento algum do banco de dados, fornecedor ou mesmo se a informação foi
